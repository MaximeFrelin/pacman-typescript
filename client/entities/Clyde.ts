  ...
  public move(): void {
    ...
    if (this.x < 0) {
      ...
      switch (this.currentKey) {
        case KeyCode.LEFT:
          if (this.anims.getCurrentKey() !== "clyde-walk-left")
            this.play("clyde-walk-left");
          ...
          break;
        case KeyCode.UP:
          if (this.anims.getCurrentKey() !== "clyde-walk-top")
            this.play("clyde-walk-top");
          ...
          break;
        case KeyCode.RIGHT:
          if (this.anims.getCurrentKey() !== "clyde-walk-right")
            this.play("clyde-walk-right");
          this.setVelocity(Configuration.PlayerSpeed * 20, 0);
          this.changeDirectionRandom();
          this.hasToTurn = false;
          setTimeout(() => (this.hasToTurn = true), 200);
          break;
        case KeyCode.DOWN:
          if (this.anims.getCurrentKey() !== "clyde-walk-bottom")
            this.play("clyde-walk-bottom");
          this.setVelocity(0, Configuration.PlayerSpeed * 20);
          this.changeDirectionRandom();
          this.hasToTurn = false;
          setTimeout(() => (this.hasToTurn = true), 200);
